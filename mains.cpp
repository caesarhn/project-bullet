...
int updateModel = 0;
float updateModelValue[3] = {0, 0, 0};
...
private:
    ...
    glm::vec2 texture_set_binding = glm::vec2(0, 1);
    ...
    void initVulkan() {
        ...
        for(int i = 0; i < textureAsset.size(); i++){
            experimentalCreateTextureImage(textureAsset[i].c_str());
        }
        experimentalCreateTextureImageView();
        experimentalCreateTextureSampler();
    ...
    void createGraphicsPipeline() {
        ...
        std::cout << "DEBUG Graphics Pipeline" << std::endl;
    ...
    void createDescriptorPool() {
        ...
        poolSizes[1].descriptorCount = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT * texturePoolSize);
        // poolSizes[0].type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    ...
    static std::vector<char> readFile(const std::string& filename) {
        ...
        try{
            ...
            std::cerr << "❌ Error membuka file: " << e.what() << std::endl;
        }
