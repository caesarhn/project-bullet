...
void main() {
    gl_Position = ubo.projection * ubo.view * entities.model * vec4(inPosition, 1.0);
    fragColor = inColor;
    fragTexCoord = inTexCoord;
    control_animation = entities.controlAnimation;
    detail_animation = entities.animationDetail;
    samplerIdx = entities.samplerIndex;
    objectType = entities.object;
}