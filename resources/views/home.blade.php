...
<html lang="en">
    <head>
        ...
        <meta name="description" content="CV HELLEN CHRISA HCR, kami berdedikasi untuk menyediakan layanan rental mobil berkualitas tinggi dengan harga terjangkau untuk memenuhi berbagai kebutuhan transportasi Anda. Kami terus berinovasi dan berkembang untuk memastikan setiap pelanggan mendapatkan pengalaman yang aman, nyaman, dan memuaskan.">
    ...
    <body>
        <a href="https://wa.me/6285368303446" class="z-1000">
            <div class="fixed flex right-3 bottom-2 w-40 h-14 bg-green-600 rounded-full overflow-hidden hover:w-44 z-1000">
                <img class="h-10 mt-2 ms-4" src="{{ asset('waicon.png') }}"/>
        ...
        <div id="main-header" class="fixed w-full sm:min-h-24 md:min-h-16 bg-slate-50 z-50 shadow-lg" dir="ltr">
            <div class="flex w-full">
                ...
                <div class="">
                    <img class="sm:max-h-24 md:max-h-16" src="{{ asset('logo-hcr.png') }}" alt="logo HCR Rental Mobil Lampung"/>
                </div>
        ...
        <main class="min-h-screen w-full font-arial" id="top">
            <div>
                <div class="slides w-full sm:max-h-84 lg:max-h-120 overflow-hidden fade">
                    <img class="object-cover w-full sm:h-84 lg:h-120" src="{{ asset('banner-mobil.jpg') }}"/>
                </div>
                <div class="slides w-full sm:h-84 lg:h-120 overflow-hidden hidden fade">
                    <img class="object-cover w-full sm:h-84 lg:h-120" src="{{ asset('banner2.jpg') }}"/>
                </div>
                <div class="slides w-full sm:h-84 lg:h-120 overflow-hidden hidden fade">
                    <img class="object-cover w-full sm:h-84 lg:h-120" src="{{ asset('fortuner.jpg') }}"/>
                </div>
                ...
                <div id="next" class="absolute sm:h-40 lg:h-80 sm:w-24 lg:w-52 top-40 right-0 content-center">
                    <img src="{{ asset('hcr-icon-next.svg') }}" class="w-20 m-auto opacity-70">
                </div>
                <div id="prev" class="absolute sm:h-40 lg:h-80 sm:w-24 lg:w-52 top-40 content-center">
                    <img src="{{ asset('hcr-icon-prev.svg') }}" class="w-20 m-auto opacity-70">
                </div>
            </div>
            <br/>
            <div class="relative sm:w-11/12 lg:w-3/4 xl:w-1/2 mt-10 mx-auto" id="product">
                ...
                <div class="grid sm:grid-cols-1 md:grid-cols-3 gap-5 text-blue-se">
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('fortuner.jpg') }}" alt="Sewa fortuner bandar lampung"/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('hiace-commuter.jpg') }}" alt="sewa mobil hiace commuter"/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('hiace-premio.jpg') }}" alt="sewa mobil hiace premio"/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('innova.jpg') }}" alt="sewa mobil innova ready lepas kunci"/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('brio.jpg') }}" alt="sewa mobil brio ready lepas kunci"/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('avanza.jpg') }}" alt="sewa mobil avanza ready lepas kunci"/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="w-full h-fit p-2 border-2 border-blue-se rounded-xl">
                        <div class="w-full h-3/5 overflow-hidden rounded-t-xl">
                            <img class="object-cover" src="{{ asset('all-new-avanza.jpeg') }}" alt="sewa mobil all new avanza ready lepas kunci"/>
                        </div>
                        <div class="mt-2">
            ...
            <div class="relative sm:w-11/12 lg:w-3/4 xl:w-1/2 sm:mx-auto mt-10">
                ...
                <div class="flex flex-wrap px-auto gap-5/100 gap-y-10">
                    <div class="sm:w-full md:w-3/10">
                        <img src="{{ asset('hcr-icon-mudah-dan-praktis.svg') }}" class="sm:w-1/2 md:w-1/2 mx-auto"/>
                    ...
                    <div class="sm:w-full md:w-3/10">
                        <img src="{{ asset('hcr-icon-harga-bersahabat.svg') }}" class="sm:w-1/2 md:w-1/2 mx-auto"/>
                    ...
                    <div class="sm:w-full md:w-3/10">
                        <img src="{{ asset('hcr-icon-berkualitas.svg') }}" class="sm:w-1/2 md:w-1/2 mx-auto"/>
                    ...
                    <div class="sm:w-full md:w-3/10">
                        <img src="{{ asset('hcr-icon-pelayanan-24jam.svg') }}" class="sm:w-1/2 md:w-1/2 mx-auto"/>
                    ...
                    <div class="sm:w-full md:w-3/10">
                        <img src="{{ asset('hcr-icon-pelayanan-ramah.svg') }}" class="sm:w-1/2 md:w-1/2 mx-auto"/>
                ...
                <div class="relative flex sm:gap-x-0 md:gap-x-32 gap-y-10 sm:flex-wrap md:flex-nowrap top-10">
                    <div class="sm:w-full md:w-auto">
                        ...
                        <div class="flex gap-5 mb-2">
                            <img src="{{ asset('hcr-icon-phone.svg') }}" class="h-12 my-auto"/>
                            <div>
                        ...
                        <div class="flex gap-5">
                            <img src="{{ asset('hcr-icon-email.svg') }}" class="h-12 my-auto"/>
                            <div class="my-auto">
                    ...
                    <div class="sm:w-full md:w-auto">
                        ...
                        <div class="flex gap-5">
                            <a href="https://www.instagram.com/sewamobillampung.hcr">
                                <img src="{{ asset('ig.png') }}" class="w-12"/>
                            </a>
                            <a href="https://wa.me/6285368303446">
                                <img src="{{ asset('waicon.png') }}" class="w-12"/>
                            </a>
                        </div>
                    </div>
                    <div class="sm:w-full md:w-auto">
