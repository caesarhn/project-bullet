...
// //Elemental
// const int ELEMENTAL_PHYSICAL = 0;
// const int ELEMENTAL_FIRE = 1;
// const int ELEMENTAL_LIGHTNING = 2;
// const int ELEMENTAL_POISON = 3;

// //WeightType
// const int WEIGHT_TYPE_LIGHT = 0;
// const int WEIGHT_TYPE_MEDIUM = 1;
// const int WEIGHT_TYPE_HEAVY = 2;