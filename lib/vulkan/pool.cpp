...
void VulkanApplication::createDescriptorPool() {
    ...
    poolSizes[0].descriptorCount = static_cast<uint32_t>((characters.size() + 10) * MAX_FRAMES_IN_FLIGHT);
    ...
    poolInfo.maxSets = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT * (characters.size() + 10));
