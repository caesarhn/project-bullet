...
bool VulkanApplication::isDeviceSuitable(VkPhysicalDevice device) {
    ...
    std::cout << "suitable: " << indices.isComplete() << " extension supported: " << extensionsSupported << std::endl;
...
bool VulkanApplication::checkDeviceExtensionSupport(VkPhysicalDevice device) {
    ...
    // std::cout << "Available extensions: " << availableExtensions.size() << std::endl;
    // std::cout << "Required extensions: " << deviceExtensions.size() << std::endl;
    // std::cout << "Missing extensions: " << requiredExtensions.size() << std::endl;
    ...
    // std::cout << "req extension: " << extensionCount << std::endl;
